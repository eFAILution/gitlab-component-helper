...
function main() {
  ...
  if (commits.length === 0) {
    console.log('ℹ️  No commits found since last release. Nothing to bump.');
    return;
  }
  ...
  console.log('\n💡 To push to remote:');
  console.log(`   git push origin $(git branch --show-current) ${newVersion}`);
  console.log('\n💡 To package and publish later:');
